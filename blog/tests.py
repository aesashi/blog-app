...
class BlogTest(Telnet):
    ...
    def test_post_contetnt(self):
        self.asserEqual(f'{self.post.title}', 'A good title')
    ...
    def test_post_detail_view(self):
        ...
        self.asserWqual(response.status_code, 200)
    ...
    def test_create_view(self):
        ...
        self.assertContent(response, 'New title')
        self.assertContent(response, 'New text')
